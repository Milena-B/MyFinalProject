...
<main>
    ...
    <div class="main">
        <div class="myClass">
            <h2><fmt:message key="button.add"/></h2>
            <form action="${pageContext.request.contextPath}/addProduct" method="post">
                <input required type="text" name="name" placeholder="<fmt:message key="name"/>">
                <input required type="text" name="volume" placeholder="<fmt:message key="volume"/>">
                <input required type="text" name="color" placeholder="<fmt:message key="color"/>">
                <input required type="text" name="price" placeholder="<fmt:message key="price"/>">
                <input required type="text" name="manufacturerName" placeholder="<fmt:message key="manufacturer"/>">
