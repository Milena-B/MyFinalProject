...
<main>
    ...
    <div class="main">
        <div class="myClass">
            <h2 align="center"><fmt:message key="admin"/></h2>
        <form action="${pageContext.request.contextPath}/users" method="get">
            <h4 align="center"><input type="submit" value="<fmt:message key="button.change.user.status"/>"></h4>
        </form>
        <form action="${pageContext.request.contextPath}/orders" method="get">
            <h4 align="center"><input type="submit" value="<fmt:message key="button.change.order.status"/>"></h4>
        </form>
        <form action="${pageContext.request.contextPath}/products" method="get">
            <h4 align="center"><input type="submit" value="<fmt:message key="button.add.delete.change"/>"></h4>
        </form>
        </div>
    </div>
</main>
