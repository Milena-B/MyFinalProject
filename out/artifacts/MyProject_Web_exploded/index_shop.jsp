...
<%@ taglib uri="/WEB-INF/myCustomTagDescriptor.tld"  prefix="tag" %>
                ...
                <li class="bg-dark-30 bg-dark shop-page-header"
                    ...
                    <div class="titan-caption">
                        <div class="caption-content">
                            <div class="font-alt mb-30 titan-title-size-4"><fmt:message key="summer"/></div>
                            <div class="font-alt mb-40 titan-title-size-1"><fmt:message key="fashion.destination"/></div>
                        </div>
                    </div>
                </li>
                <li class="bg-dark-30 bg-dark shop-page-header"
                    ...
                    <div class="titan-caption">
                        <div class="caption-content">
                            <div class="font-alt mb-40 titan-title-size-4"><fmt:message key="exclusive.products"/></div>
                        </div>
                    </div>
                </li>
            </ul>
