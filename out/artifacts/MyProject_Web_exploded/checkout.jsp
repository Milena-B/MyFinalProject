...
<main>
    ...
    <div class="main">
        <form action="${pageContext.request.contextPath}/orderController" method="post">
            <h2 align="center" ><fmt:message key="information.about.order"/></h2>
            <div class="checkout">
                                ...
                                <div class="billing-address">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div style="color: #D53E36;">${errors.cardNumber}</div>
                                            <input name="cardNumber" value="${order.cardNumber}"class="form-control" placeholder="<fmt:message key="placeholder.card"/>" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="checkout-inner">
                                <div class="checkout-summary">
                                    <h2><fmt:message key="total.order"/><span>${cartService.totalSum}</span></h2>
                                </div>
                                <div class="checkout-payment">
                                    <div class="checkout-btn">
                                        <input class="btn" value="<fmt:message key="button.make.order"/>"type="submit">
                                    </div>
                                </div>
                            </div>
                        </div>
