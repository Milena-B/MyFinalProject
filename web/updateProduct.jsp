...
<main>
    ...
    <div class="main">
        <div class="myClass">
            <h2><fmt:message key="edit.product"/></h2>
            <form action="${pageContext.request.contextPath}/updateProduct" method="post">
                <input type="text" name="id" value="${param.id}" placeholder=${param.id}>
                <input type="text" name="name" value="${param.name}" placeholder=${param.name}>
                <input type="text" name="volume" value="${param.volume}" placeholder=${param.volume}>
                <input type="text" name="color" value="${param.color}" placeholder=${param.color}>
                <input type="text" name="price" value="${param.price}" placeholder=${param.price}>
                <input type="text" name="manufacturerName" value="${param.manufacturerName}"
                       placeholder=${param.manufacrurerName}>
