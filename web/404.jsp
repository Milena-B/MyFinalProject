    ...
    <section class="home-section home-parallax home-fade home-full-height bg-dark bg-dark-30" id="home"
        ...
        <div class="titan-caption">
            <div class="caption-content">
                <div class="font-alt mb-30 titan-title-size-4"><fmt:message key="404.error"/></div>
                <div class="font-alt"><fmt:message key="404.error.1"/><br/><fmt:message key="404.error.2"/>
                </div>
