    ...
    <div class="main" >
        ...
        <table border="2" align="center">
            <tr>
                ...
                <th><fmt:message key="admin.userEmail"/></th>
                <th><fmt:message key="admin.user.FirstName"/></th>
                <th><fmt:message key="admin.user.LastName"/></th>
            ...
            <form class="form" action="${pageContext.request.contextPath}/UnbanUser" method="post">
                <div class="form-group">
                    <input class="form-control" id="email" type="text" name="email" placeholder="<fmt:message key="email"/>"/>
                </div>
                <div class="form-group">
                    <button class="btn btn-round btn-b"><fmt:message key="button.unblock"/></button>
                </div>
            </form>
            <form class="form" action="${pageContext.request.contextPath}/BanUser" method="post">
                <div class="form-group">
                    <input class="form-control" id="email" type="text" name="email" placeholder="<fmt:message key="email"/>"/>
                </div>
                <div class="form-group">
                    <button class="btn btn-round btn-b"><fmt:message key="button.block"/></button>
                </div>
            </form>
        </body>
    </div>
