...
<main>
    ...
    <div class="main">
        ...
        <table border="2" align="center">
            <tr>
                <th><fmt:message key="admin.userId"/></th>
                <th><fmt:message key="admin.user.Status"/></th>
                <th><fmt:message key="cabinet.order.address"/></th>
                <th><fmt:message key="cabinet.order.card"/></th>
            ...
            <tr>
                ...
                <td>${order.getCardNumber()}</td>
                <td>${order.getUserId()}</td>
            </tr>
            </c:forEach>
        </table>

            <form class="form" action="${pageContext.request.contextPath}/registered" method="post">
                <div class="form-group">
                    <input class="form-control" id="id" type="text" name="id" placeholder="<fmt:message key="admin.userId"/>"/>
                </div>
                <div class="form-group" align="center">
                    <button><fmt:message key="status.registered"/></button>
                </div>
            </form>
            <form class="form" action="${pageContext.request.contextPath}/paid" method="post">
                <div class="form-group">
                    <input class="form-control" id="id" type="text" name="id" placeholder="<fmt:message key="admin.userId"/>"/>
                </div>
                <div class="form-group" align="center">
                    <button><fmt:message key="status.paid"/></button>
                </div>
            </form>
            <form class="form" action="${pageContext.request.contextPath}/canceled" method="post">
                <div class="form-group">
                    <input class="form-control" id="id" type="text" name="id" placeholder="<fmt:message key="admin.userId"/>"/>
                </div>
                <div class="form-group" align="center">
                    <button><fmt:message key="status.canceled"/></button>
                </div>
            </form>
        </body>
    </div>
